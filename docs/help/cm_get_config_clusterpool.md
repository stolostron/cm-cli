## cm get config clusterpool

Display the config of a cluster
...
```
	...
	cm get config clusterpool <clusterpool_name> [--output-file <file_name]
...
```
  ...
  -h, --help                  help for clusterpool
      --output-file string    The config will be copied in the specified file
      --without-credentials   If set the platform credentials will be not inserted in the config
```
