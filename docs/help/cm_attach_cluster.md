...
# Attach a cluster
cm attach cluster --values values.yaml

# Attach a cluster with overwritting the cluster name
cm attach cluster --cluster mycluster --values values.yaml

# Attach a cluster with overwritting the cluster name as arg
cm attach cluster mycluster --values values.yaml
