...
# Create a cluster
cm create cluster --values values.yaml

# Create a cluster with cluster name overwrite
cm create cluster --cluster mycluster --values values.yaml

# Create a cluster with cluster name overwrite by args
cm create cluster mycluster --values values.yaml
