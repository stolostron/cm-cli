## cm scale clusterpool

Scale clusterpool

```
cm scale clusterpool [flags]
```
...
# Scale clusterpool
cm scale cp <clusterpool_name> --size <size> <options>

# Scale clusterpool on a given clusterpoolhost
cm scale cp <clusterpool_name> --size <size> --cph <clusterpoolhost> <options>
