## cm delete hypershiftdeployment

Delete hypershiftdeployment

```
cm delete hypershiftdeployment [flags]
```
...
cm delete hd <hypershiftdeployment_name>[,<hypershiftdeployment_name>...] <options>
