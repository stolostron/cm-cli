...
cm install acm --namespace <namespace> --channel <channel> [--manual-approval]
...
```
  ...
  -h, --help                   help for acm
      --manual-approval        Set for manual approval otherwize automatic
      --operatorGroup string   The operator group (default "open-cluster-management-group")
      --output-file string     The generated resources will be copied in the specified file
      --timeout int            Timeout to get ACM installed in minutes (default 30)
      --wait                   Wait until ACM installed is completed
```
