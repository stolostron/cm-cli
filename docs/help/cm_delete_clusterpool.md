## cm delete clusterpool

Delete clusterpools

```
cm delete clusterpool [flags]
```
...
cm delete cp <clusterpool_name>[,<clusterpool_name>...] <options>

# Delete a clusterpool on a given clusterpoolhost
cm delete cp <clusterpool_name>[,<clusterpool_name>...] -cph <clusterpoolhost_name> <options>
