...
use clusterclaim change the current context to a cluster claim

### Synopsis

use clusterclaim change the current context to a cluster claim, optionally the cluster pool host can be provided to override the current one

```
cm use clusterclaim [flags]
```
...
# Use a cluster
cm use cc <cluster_claim_name>

# Use a cluster on a given clusterpoolhosts
cm use cc <cluster_claim_name> --cph <cluster_pool_host_name>
