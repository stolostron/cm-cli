...
* [cm bind clusterpoolhost](cm_bind_clusterpoolhost.md)	 - set cph makes the given clusterpoolhost active/current
* [cm bind clusterset](cm_bind_clusterset.md)	 - bind a clusterset to a namespace
