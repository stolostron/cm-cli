## cm get clusterclaims

Display clusterclaims
...
```
	...
	cm get cc <clusterclaim_name> 
	
	# get clusterclaims on a specific clusterpoolhost
	cm get cc  <clusterclaim_name> --cph <clusterpoolhosts>
...
```
  -A, --all-cphs                      If the requested object does not exist the command will return exit code 0.
