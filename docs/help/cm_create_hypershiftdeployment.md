## cm create hypershiftdeployment

hypershiftdeployment a cluster

```
cm create hypershiftdeployment [flags]
```
...
cm create hypershiftdeployment --values values.yaml

# Create a hypershiftdeployment with cluster name overwrite by args
cm create hypershiftdeployment mycluster --values values.yaml
