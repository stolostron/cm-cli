...
# Delete a cluster
cm delete cluster --values values.yaml

# Delete a cluster with overwritting the cluster name
cm delete cluster  --cluster mycluster --values values.yaml

# Delete a cluster with overwritting the cluster name with arg
cm delete cluster mycluster--values values.yaml
