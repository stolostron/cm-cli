## cm delete clusterclaim

Delete clusterclaims

```
cm delete clusterclaim [flags]
```
...
cm delete cc <clusterclaim_name>[,<clusterclaim_name>...] <options>

# Delete a clusterclaim on a given clusterpoolhost
cm delete cc <clusterclaim_name>[,<clusterclaim_name>...] -cph <clusterpoolhost_name> <options>
