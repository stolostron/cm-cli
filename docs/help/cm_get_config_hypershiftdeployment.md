## cm get config hypershiftdeployment

Display the config of a hypershiftdeployment
...
```
	...
	cm get config hypershiftdeployment <cluster-name> -n <managedcluster_name> [--output-file <file_name]
...
```
  -h, --help                 help for hypershiftdeployment
