...
var example = `
# Run clusterclaims
%[1]s run clusterclaim|cc <clusterclaim_name>[,<clusterclaim_name>...] <options>

# run clusterclaims on a given clusterpoolhost
%[1]s run clusterclaim|cc <clusterclaim_name>[,<clusterclaim_name>...] <clusterpoolhost> <options>
`
