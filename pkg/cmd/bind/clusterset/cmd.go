...
import (
	...
	clusteradmbind "open-cluster-management.io/clusteradm/pkg/cmd/clusterset/bind"
...
%[1]s bind clusterset clusterset1 --namespace default
`
...
func NewCmd(clusteradmFlags *genericclioptionsclusteradm.ClusteradmFlags, cmFlags *genericclioptionscm.CMFlags, streams genericclioptions.IOStreams) *cobra.Command {
	cmd := clusteradmbind.NewCmd(clusteradmFlags, streams)
	cmd.Use = "clusterset"
