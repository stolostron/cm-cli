...
TMP=$(mktemp -d)
rm -rf $TMP/github.com/stolostron/${PROJECT_NAME}
...
APIS_PKG=github.com/stolostron/${PROJECT_NAME}/api
FQ_APIS=github.com/stolostron/${PROJECT_NAME}/api/cm-cli/v1alpha1
...
cp -r $TMP/github.com/stolostron/${PROJECT_NAME}/* .
